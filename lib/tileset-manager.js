...
class Tile {
  constructor({ spritesheet, tileName, shortcode, id, x, y, width, height }) {
    ...
    this.height = null;
    this.entry = null;
    this.update({ spritesheet, tileName, shortcode, id, x, y, width, height});
  }
  ...
  update({
    ...
    this.entry.image = this.spritesheet.src,
    this.entry.imageWidth = this.spritesheet.width,
    this.entry.imageHeight = this.spritesheet.height,
    this.entry.x = this.x,
    this.entry.y = this.y,
    this.entry.cropWidth = this.width,
    this.entry.cropHeight = this.height,
    this.entry.title = this.tileName,
    //this.entry.description = [this.shortcode, this.id, this.x, this.y, this.width, this.height].join(", "),
    //this.entry.scale = 2,
    this.entry.update();
  }
